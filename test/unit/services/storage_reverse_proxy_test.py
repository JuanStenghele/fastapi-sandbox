...
class TestStorageReverseProxy():
  def test_get_stored_object_returns_result(self):
    ...
    storage_client_mock.get_object.assert_called_once_with(f"{PUBLIC_PATH}/images/photo.png")
  ...
  def test_get_stored_object_returns_none(self):
    ...
    storage_client_mock.get_object.assert_called_once_with(f"{PUBLIC_PATH}/missing.txt")
